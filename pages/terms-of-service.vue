<template>
  <v-app>
    ...
    <v-main>
      <v-container fluid class="px-2 py-6 mt-2">
        <h2>利用規約</h2>
        <p class="mt-3">
          この利用規約（以下，「本規約」といいます。）は、みんなのイベント（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザー（以下，「ユーザー」といいます。）は，本規約に従って本サービスをご利用いただきます。
        </p>
        ...
        <ol class="mt-3">
          ...
          <li>
            当社は本サービスに関し，本規約のほか，ご利用にあたってのルール等（以下，「個別規定」といいます。）を定めることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。
          </li>
          <li>
            本規約の規定が前条の個別規定の規定と矛盾する場合には，個別規定において特段の定めがない場合に限り，個別規定の規定が優先されるものとします。
          </li>
        </ol>
